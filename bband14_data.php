...
$sql2 = $conn->prepare("INSERT INTO bband14 (id_csv,Date,rerata,sdp,uBand,lBand,bbRange) VALUES (:id_csv,:tanggal,:rerata,:sdp,:uBand,:lBand,:bbRange)");
...
//BollingerBands-End
header("location: bband20_data.php?saham=".urlencode($_GET['saham']));
?>
